...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 884.0, 60.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 884.0, 100.0, 219.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 773.746673583984375, 40.0, 42.0, 22.0 ],
					"text" : "/dump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 767.0, 125.0, 87.0, 22.0 ],
					"text" : "spat5.osc.view"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 542.0, 158.0, 100.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 543.5, 188.0, 97.0, 22.0 ],
					"text" : "/panning/type $1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 896.0, 234.0, 74.0, 22.0 ],
									"text" : "receive~ in8"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 896.0, 307.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 789.0, 234.0, 74.0, 22.0 ],
									"text" : "receive~ in7"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 789.0, 307.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 674.0, 234.0, 74.0, 22.0 ],
									"text" : "receive~ in6"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 674.0, 307.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 567.0, 234.0, 74.0, 22.0 ],
									"text" : "receive~ in5"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 567.0, 307.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 452.0, 234.0, 74.0, 22.0 ],
									"text" : "receive~ in4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 345.0, 234.0, 74.0, 22.0 ],
									"text" : "receive~ in3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 345.0, 307.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 230.0, 234.0, 74.0, 22.0 ],
									"text" : "receive~ in2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 123.0, 234.0, 74.0, 22.0 ],
									"text" : "receive~ in1"
								}
...
,
					"patching_rect" : [ 94.0, 46.0, 438.000000000000114, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 651.0, 195.0, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 94.0, 315.0, 385.625, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 94.0, 151.0, 438.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.spat~ @inputs 8 @outputs 8 @rooms 1 @initwidth \"/panning/type angular\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 657.5, 80.0, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 657.5, 40.0, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 643.5, 119.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 674.5, 120.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 184.0, 643.5, 140.0, 60.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 711.5, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 711.5, 82.0, 22.0 ],
					"text" : "/preset/export"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.0, 751.5, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 830.746673583984375, 690.0, 60.0, 20.0 ],
					"text" : "<live.tex>"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 239.999999999999943, 609.0, 179.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 239.999999999999943, 572.0, 268.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 139.666670262813568, 602.0, 68.0, 22.0 ],
					"text" : "send~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 602.0, 68.0, 22.0 ],
					"text" : "send~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 860.746673583984375, 319.5, 393.0, 87.0 ],
...
,
					"patching_rect" : [ 552.746673583984375, 672.0, 152.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.746673583984375, 751.5, 151.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 467.963363647460938, 662.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 553.746673583984375, 638.5, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 716.746673583984375, 664.5, 99.0, 20.0 ],
					"text" : "some controls —"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 716.746673583984375, 692.5, 112.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.963363647460938, 718.5, 29.5, 22.0 ],
					"text" : "/hrtf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 467.963363647460938, 688.5, 41.0, 21.0 ],
					"text" : "kemar"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.746673583984375, 718.5, 46.0, 22.0 ],
					"text" : "/hrtf $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.746673583984375, 638.5, 101.0, 22.0 ],
...
,
					"patching_rect" : [ 532.746673583984375, 718.5, 57.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 56.0, 448.0, 170.0, 116.0 ],
					"relative" : 1,
					"saved_attribute_attributes" : 					{
						"focusbordercolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 716.746673583984375, 718.5, 237.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 776.746673583984375, 523.5, 164.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 716.746673583984375, 523.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 519.746673583984375, 284.0, 321.0, 116.0 ],
					"relative" : 1,
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_meter_bg"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 716.746673583984375, 552.5, 224.0, 102.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 477.463363647460938, 714.5, 460.246673583984375, 714.5 ],
					"source" : [ "obj-101", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 542.246673583984375, 746.5, 460.246673583984375, 746.5 ],
					"source" : [ "obj-105", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 660.5, 270.0, 103.5, 270.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 667.0, 138.0, 103.5, 138.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 470.125, 270.0, 831.246673583984375, 270.0 ],
					"order" : 0,
					"source" : [ "obj-6", 7 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 417.75, 270.0, 788.103816441127265, 270.0 ],
					"order" : 0,
					"source" : [ "obj-6", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 365.375, 270.0, 744.960959298270154, 270.0 ],
					"order" : 0,
					"source" : [ "obj-6", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 313.0, 270.0, 701.81810215541293, 270.0 ],
					"order" : 0,
					"source" : [ "obj-6", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 260.625, 270.0, 658.67524501255582, 270.0 ],
					"order" : 0,
					"source" : [ "obj-6", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 208.25, 270.0, 615.532387869698709, 270.0 ],
					"order" : 0,
					"source" : [ "obj-6", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 155.875, 270.0, 572.389530726841485, 270.0 ],
					"order" : 0,
					"source" : [ "obj-6", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 103.5, 270.0, 529.246673583984375, 270.0 ],
					"order" : 0,
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 509.463363647460938, 746.5, 460.246673583984375, 746.5 ],
					"source" : [ "obj-99", 0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Documents/myClasses/sound-synth-tech/week_11",
				"patcherrelativepath" : ".",
				"type" : "JPEG",
				"implicit" : 1
			}
